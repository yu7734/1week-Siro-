...
public class ObjectTorque : MonoBehaviour
{
    ...
    private void InclineTorque()
    {
        ...
        Vector3 rotationTorque = new Vector3(-player.GetSetInputMove.y * pithcTorqueMagnitude, player.GetSetInputMove.x * yawTorqueMagnitude, -player.GetSetInputMove.x * rollTorqueMagnitude);
